...
public class Task20Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    int saveIndexList;
    boolean flFactor2Button, flFactor3Button, flYesButton, flNoButton, somethingIsChecked,
            getAnswerIsSelected, flMyLastOne, flAnotherPlayer, ERROR, saveLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flFactor2Button = flFactor3Button = somethingIsChecked = flYesButton = flNoButton =
                getAnswerIsSelected = flMyLastOne = flAnotherPlayer = ERROR = saveLayout = false;
    }
