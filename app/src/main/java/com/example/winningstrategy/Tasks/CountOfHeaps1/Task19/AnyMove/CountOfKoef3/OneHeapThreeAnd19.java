package com.example.winningstrategy.Tasks.CountOfHeaps1.Task19.AnyMove.CountOfKoef3;

public class OneHeapThreeAnd19 {
    ...
    public OneHeapThreeAnd19(int NumberOfAdded1, int NumberOfAdded2, int NumberOfMultiply, int Winning) {
