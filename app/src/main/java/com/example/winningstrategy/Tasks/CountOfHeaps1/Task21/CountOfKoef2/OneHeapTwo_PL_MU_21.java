...
public class OneHeapTwo_PL_MU_21 {
    ...
    public OneHeapTwo_PL_MU_21(int NumberOfAdded1, int NumberOfMultiply, int Winning) {
    ...
    private boolean CalculationsDelete(int x, int h) {
        ...
        if (h < 3 && x >= Winning)
            ...
            if (h % 2 == 0)
                return CalculationsDelete(x + NumberOfAdded1, h + 1) || CalculationsDelete(x * NumberOfMultiply, h + 1);
            else
                return CalculationsDelete(x + NumberOfAdded1, h + 1) && CalculationsDelete(x * NumberOfMultiply, h + 1);
        }
    }
