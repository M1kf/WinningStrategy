package com.example.winningstrategy.Tasks.CountOfHeaps1.Task21.CountOfKoef3.NoSame;

import java.util.ArrayList;
import java.util.List;

public class OneHeapThreeNoSame2Player21 {
    ...
    public OneHeapThreeNoSame2Player21(int NumberOfAdded1, int NumberOfAdded2, int NumberOfMultiply, int Winning) {
