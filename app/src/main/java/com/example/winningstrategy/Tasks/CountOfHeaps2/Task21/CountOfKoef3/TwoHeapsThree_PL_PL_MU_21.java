package com.example.winningstrategy.Tasks.CountOfHeaps2.Task21.CountOfKoef3;

import java.util.ArrayList;
import java.util.List;
import java.util.Objects;

public class TwoHeapsThree_PL_PL_MU_21 {
    ...
    public TwoHeapsThree_PL_PL_MU_21(int numberOfAdded1, int numberOfAdded2, int numberOfMultiply, int numberOfStonesInAHeap, int winning) {
    ...
    private boolean CalculationsDelete(int x, int y, int h) {
        ...
        if (h < 3 && x + y >= Winning)
            ...
            if (h % 2 == 0)
                return CalculationsDelete(x + NumberOfAdded1, y + NumberOfAdded2, h + 1) || CalculationsDelete(x + NumberOfAdded2, y + NumberOfAdded1, h + 1) ||
