package com.example.winningstrategy.Tasks.CountOfHeaps1.Task19.UnluckyMove.CountOfKoef2;

public class OneHeapTwoOr_PL_MU_PL_19 {
    ...
    public OneHeapTwoOr_PL_MU_PL_19(int NumberOfAdded1, int NumberOfMultiplied, int NumberOfAdded, int Winning) {
