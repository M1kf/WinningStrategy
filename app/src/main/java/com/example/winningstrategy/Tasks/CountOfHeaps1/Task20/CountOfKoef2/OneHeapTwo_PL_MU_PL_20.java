package com.example.winningstrategy.Tasks.CountOfHeaps1.Task20.CountOfKoef2;

import java.util.ArrayList;
import java.util.List;

public class OneHeapTwo_PL_MU_PL_20 {
    ...
    public OneHeapTwo_PL_MU_PL_20(int NumberOfAdded1, int NumberOfMultiply, int NumberOfSubtract, int Winning) {
