...
public class TwoHeapsThree_PL_MU_MU_21 {
    ...
    public TwoHeapsThree_PL_MU_MU_21(int numberOfAdded, int numberOfMultiply1, int numberOfMultiply2, int numberOfStonesInAHeap, int winning) {
        ...
        if (h < 3 && x + y >= Winning)
            ...
            if (h % 2 == 0)
                return CalculationsDelete(x + NumberOfAdded, y, h + 1) || CalculationsDelete(x, y + NumberOfAdded, h + 1) ||
                        CalculationsDelete(x, y  * NumberOfMultiply1, h + 1) || CalculationsDelete(x  * NumberOfMultiply2, y, h + 1);
            else
                return CalculationsDelete(x + NumberOfAdded, y, h + 1) && CalculationsDelete(x, y + NumberOfAdded, h + 1) &&
                        CalculationsDelete(x, y  * NumberOfMultiply1, h + 1) && CalculationsDelete(x  * NumberOfMultiply2, y, h + 1);
        }
