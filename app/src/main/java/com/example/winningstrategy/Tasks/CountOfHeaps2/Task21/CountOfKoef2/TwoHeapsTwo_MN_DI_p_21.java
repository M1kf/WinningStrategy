...
public class TwoHeapsTwo_MN_DI_p_21 {
    ...
    public TwoHeapsTwo_MN_DI_p_21(int numberOfDeducted, int numberOfDivided, int numberOfStonesInAHeap, int winning) {
        ...
        if (h < 3 && x + y <= Winning)
            ...
            if (h % 2 == 0)
                return CalculationsDelete(x - NumberOfDeducted, y, h + 1) || CalculationsDelete(x, y - NumberOfDeducted, h + 1) ||
                        CalculationsDelete(x / NumberOfDivided + x % NumberOfDivided, y, h + 1) || CalculationsDelete(x, y / NumberOfDivided + y % NumberOfDivided, h + 1);
            else
                return CalculationsDelete(x - NumberOfDeducted, y, h + 1) && CalculationsDelete(x, y - NumberOfDeducted, h + 1) &&
                        CalculationsDelete(x / NumberOfDivided + x % NumberOfDivided, y, h + 1) && CalculationsDelete(x, y / NumberOfDivided + y % NumberOfDivided, h + 1);
        }
